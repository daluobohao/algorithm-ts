...
exports.divide = exports.multiply = exports.minus = exports.plus = void 0;
/**
...
function multiply(num1, num2) {
    // 取绝对值
    var num1Abs = num1 < 0 ? plus(~num1, 1) : num1;
    var num2Abs = num2 < 0 ? plus(~num2, 1) : num2;
    // 计算绝对值的乘积
    // 记录循环次数
    var count = 0;
    // 最终结果
